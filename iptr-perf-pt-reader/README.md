...
[linux-perf-data](https://crates.io/crates/linux-perf-data) crate provides a more general interface for dealing with `perf.data`. However, this crate's support for AUXTRACE header is not completed, see [issue#22](https://github.com/mstange/linux-perf-data/pull/21).
